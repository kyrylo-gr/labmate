...
Before, figures were saved with pickle library. But then figures cannot be opened on different systems. So new library `pltsave` was used. This allows to save and open the figure.
...
- Parsing multiline values from config files.
